...
hi NonText              guifg=#438ec3   guibg=#eef8ff
...
" Jinja Highlighting
hi jinjaTagBlock        guifg=#ff0007   guibg=#ffffff   gui=bold
hi jinjaVarBlock        guifg=#ff0007   guibg=#ffffdd
hi jinjaString          guifg=#0086d2   guibg=#ffffff
hi jinjaNumber          guifg=#bf0945   guibg=#ffffff   gui=bold
hi jinjaStatement       guifg=#fb660a   guibg=#ffffdd   gui=bold
hi jinjaComment         guifg=#22a21f   guibg=#dbf3cd   gui=italic
hi jinjaFilter          guifg=#ff0086   guibg=#ffffdd
hi jinjaRaw             guifg=#aaaaaa   guibg=#ffffff
hi jinjaOperator        guifg=#ff0086   guibg=#ffffff   gui=bold
hi jinjaVariable        guifg=#92cd35   guibg=#ffffff
hi jinjaAttribute       guifg=#dd7700   guibg=#ffffff
hi jinjaSpecial         guifg=#008ffd   guibg=#ffffff
