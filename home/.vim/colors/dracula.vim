...
hi CursorLine ctermbg=234 cterm=NONE guifg=NONE guibg=#181a26 gui=NONE
...
hi Normal guifg=#f8f8f2 guibg=#1e1f28 gui=NONE
...
hi Type ctermfg=NONE ctermbg=NONE cterm=NONE guifg=#8be9fd guibg=NONE gui=NONE
